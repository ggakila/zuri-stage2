				...
				const fetchData = async () => {
					const options = {
						...
						headers: {
							...
							Authorization:
								"Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJhYTNmNzU2OWFiMWM5ODUxYTMzNWQwYTQ3ZTQ0ODE4NSIsInN1YiI6IjY1MDAxZGE0ZGI0ZWQ2MTAzM2EyMDQ1OCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.wMFDbHJx2cd_hJtKOvWd4MlbjEGWSrY03vvIcQPyHWI",
						},
					};
					...
					<div className="px-[10px] md:px-[40px] w-full h-1/2">
						<div className="flex justify-between">
							<div className="flex items-center ">
								<h1
									className="text-[16px] lg:text-[20px] text-gray-600 font-semibold pr-4 leading-normal"
								...
								<div className="w-[5px] h-[5px] mr-3 bg-gray-600 border rounded-full"></div>
								<p
									className="text-[14px] lg:text-[20px] text-gray-600 font-semibold pr-4 leading-normal"
									data-testid="movie-runtime"
								>
									{runtime}
								</p>{" "}
								<p className="text-[14px] lg:text-[20px] text-gray-600 font-semibold pr-4 leading-normal">
									mins
								</p>
						...
						<div className="flex flex-col lg:flex-row gap-10">
							<div className="lg:w-2/3 flex flex-col">
								<p
									className="text-[15px] md:text-[20px] my-[30px] text-custom-gray"
								...
								<div>
									...
									<p className="text-[15px] md:text-[20px] text-rose-600 font-medium my-[25px]">
										<span className="text-custom-gray">Writers :</span>{" "}
										{writers}
									</p>
